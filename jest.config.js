/*
Convert the path-mapping from tsconfig to moduleNameMapper format
- It is to make sure the path mapping of tsconfig is being reused by the Jest
- Note: it does not support "*" -> (.+) mapping
*/
// Ref: https://stackoverflow.com/questions/61996234/requiring-a-json-with-comments-in-node-js
const requireJSON5 = require("require-json5");

const tsconfig = requireJSON5("./tsconfig.json");

// Ref: https://www.npmjs.com/package/tsconfig-paths-jest
...
module.exports = {
  ...
  // cacheDirectory: "/private/var/folders/f_/4326mhmx4kgcsfgd3g2r26rm0000gn/T/jest_dx",
